...
# Blogroll
LINKS = (
    ('Advisor or Adviser', 'https://medium.com/dirty-data/advisor-or-adviser-cc063acef267'),
    ('Data are Beautiful', 'https://medium.com/dirty-data/data-are-beautiful-356332cdb81'),
    ('The Physics of Babies', 'https://medium.com/@philshem/life-in-the-baby-universe-f52561c4a8ae'),
)
